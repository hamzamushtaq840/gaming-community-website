...
import JobsRecommendations from '../components/Jobs/JobsRecommendations'
import JobsResult from '../components/Jobs/JobsResult'
      ...
      <div className='flex gap-[30px]'>
        ...
        <div className='flex-1'>
          <div className='flex relative h-[57px]'>
            ...
            <input className='flex-1 h-full rounded-[9px] bg-[rgba(255,255,255,0.3)] indent-[70px]' placeholder='Search Jobs' />
