      ...
      <div className='flex flex-col w-[50vw] h-[100vh] md:w-[65vw] xsm:w-full sm:w-full bg-black'>
        <div className='flex flex-col flex-1 justify-center px-[10.5vw]'>
          <div className='flex flex-col'>
            <h1 className='font-[600] text-[1.625em] text-white mb-[15px] text-center leading-[29.77px]'>(name of Community 1) Login</h1>
            <p className='font-[400] text-[1em] text-white opacity-[0.75] leading-[21.84px] mb-[78px] text-center'>All-in-one platform to achieve your community goals.</p>
