  ...
  return (
    <div className='dark:text-white dark:bg-black pr-[10.989583333333334vw] pl-[10.9375vw]'>
      ...
      <div className='flex gap-[11px] pt-[71px] pb-[62px]'>
        <NavLink to={'/profile'} className={({isActive})=> isActive ? "bg-primary text-white rounded-[9px]":"bg-[rgba(255,255,255,0.25)] rounded-[9px]"}>
          <button className='w-[200px] h-[48px] bg-inherit rounded-[9px]'>View Profile</button>
        </NavLink>
