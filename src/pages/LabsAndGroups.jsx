...
const LabsAndGroups = () => {
    return (
        <div className='py-[64px] xsm:px-[6vw] lg:px-[6vw] sm:px-[6vw] gap-[10.9375vw] px-[9.598958333333334vw] dark:bg-black dark:text-white bg-white text-black'>
            ...
            <div className='flex items-start xsm:flex-col sm:flex-col md:flex-col xsm:gap-[20px] sm:gap-[20px] gap-[2.0833333333333335vw]'>
                <button className='buttonAnimation transition-all cursor-pointer flex gap-[8px] py-[1em] px-[4.14em] leading-[20.7px] text-custom-18 items-center justify-center bg-primary rounded-[9px] xsm:h-[46.39px]'><HiPlus />Add Group</button>
