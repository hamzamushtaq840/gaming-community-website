...
import previousProjects from './../assets/previousProjects.svg'
        ...
        <div className='flex flex-col gap-[28px] w-[70%] xsm:w-full sm:w-full'>
          ...
          <div className='flex flex-col dark:bg-[#2C2C2C] bg-white w-full rounded-t-[27.5px] rounded-b-[9px]'>
            <div className='px-[23px] flex items-center gap-[7.99px] h-[65px]'>
              ...
              <p className='text-[clamp(12px,1.3020833333333333vw,18px)] font-[700]'>Companies Team Profile 1 worked for</p>
            </div>
            <div className='py-[1px] dark:bg-[#FFFFFF] bg-black mb-3 opacity-[0.15] gap-[18px]'></div>
            <div className='flex gap-y-[30px] px-[3.0598958333333335vw] mt-[22px] flex-wrap justify-center'>
              <div className='flex items-start'>
                <div className='flex flex-col gap-[13px] items-center'>
                  ...
                  <p className='text-[clamp(10px,0.9114583333333334vw,14px)] font-[400] max-w-[6.770833333333333vw] text-center'>Bethesda Game Studios</p>
                </div>
            ...
            <div className='h-[56px] bg-[#EC1F26] mt-[42px] rounded-b-[9px] flex justify-center items-center gap-[7px]'>
              ...
              <p className='text-[clamp(11px,0.9114583333333334vw,16px)] font-[400]'>Add Company</p>
            </div>
          </div>

          <div className='flex flex-col dark:bg-[#2C2C2C] bg-white w-full rounded-t-[27.5px] rounded-b-[9px]'>
            <div className='px-[23px] flex items-center gap-[7.99px] h-[65px]'>
              <img src={previousProjects} alt="" className='w-[33px]' />
              <p className='text-[clamp(12px,1.3020833333333333vw,18px)] font-[700]'>Previous Projects</p>
            </div>
            <div className='py-[1px] dark:bg-[#FFFFFF] bg-black mb-3 opacity-[0.15] gap-[18px]'></div>
            <div className='flex flex-col gap-[18px] px-[25px] mt-[22px]'>
              {teamMembersss.map((value, index) => {
                return (
                  <SingleTeamMember key={index} value={value} />
                )
              })}
            ...
            <div className='h-[56px] bg-[#EC1F26] mt-[42px] rounded-b-[9px] flex justify-center items-center gap-[7px]'>
              ...
              <p className='text-[clamp(11px,0.9114583333333334vw,16px)] font-[400]'>Add Project</p>
            </div>
          </div>
          ...
          <div className='flex flex-col dark:bg-[#2C2C2C] bg-white w-full rounded-t-[27.5px] rounded-b-[9px]'>
            <div className='px-[23px] flex items-center gap-[7.99px] h-[65px]'>
              ...
              <p className='text-[clamp(12px,1.3020833333333333vw,18px)] font-[700]'>Team Mentors</p>
            </div>
            <div className='py-[1px] dark:bg-[#FFFFFF] bg-black mb-3 opacity-[0.15] gap-[18px]'></div>
            <div className='flex flex-col gap-[18px] px-[25px] mt-[22px]'>
              {teamMemberss.map((value, index) => {
            ...
            <div className='h-[56px] bg-[#EC1F26] mt-[42px] rounded-b-[9px] flex justify-center items-center gap-[7px]'>
              ...
              <p className='text-[clamp(11px,0.9114583333333334vw,16px)] font-[400]'>Add Mentor</p>
            </div>
          </div>

          <div className='flex flex-col dark:bg-[#2C2C2C] bg-white w-full rounded-t-[27.5px] rounded-b-[9px]'>
            <div className='px-[23px] flex items-center gap-[7.99px] h-[65px]'>
              <img src={expertise} alt="" className='w-[33px]' />
              <p className='text-[clamp(12px,1.3020833333333333vw,18px)] font-[700]'>Expertise</p>
            </div>
            <div className='py-[1px] dark:bg-[#FFFFFF] bg-black mb-3 opacity-[0.15] gap-[18px]'></div>
            <div className='flex gap-y-[30px] gap-x-[23px] px-[2.1484375vw] mt-[22px] flex-wrap justify-center'>
              <div className='flex flex-col border-[1.5px] border-[#EC1F26] rounded-[6px] w-[134px] h-[134px] pt-[10.79px] px-[10.79px]'>
                ...
                <div className='flex flex-1 flex-col justify-center items-center gap-[10.73px]'>
                  ...
                  <p className='text-[clamp(10px,0.9114583333333334vw,14px)] font-[400] leading-[17.15px] text-center'>Game Writing Development</p>
                </div>
              </div>
              <div className='flex flex-col border-[1.5px] border-[#EC1F26] rounded-[6px] w-[134px] h-[134px] pt-[10.79px] px-[10.79px]'>
                <div className='flex justify-end'><ImCross className='text-[#FF5359] w-[13px] cursor-pointer' /></div>
                <div className='flex flex-1 flex-col justify-center items-center gap-[10.73px]'>
                  ...
                  <p className='text-[clamp(10px,0.9114583333333334vw,14px)] font-[400] leading-[17.15px] text-center'>Product Management</p>
                </div>
              </div>
              <div className='flex flex-col border-[1.5px] border-[#EC1F26] rounded-[6px] w-[134px] h-[134px] pt-[10.79px] px-[10.79px]'>
                <div className='flex justify-end'><ImCross className='text-[#FF5359] w-[13px] cursor-pointer' /></div>
                <div className='flex flex-1 flex-col justify-center items-center gap-[10.73px]'>
                  ...
                  <p className='text-[clamp(10px,0.9114583333333334vw,14px)] font-[400] leading-[17.15px] text-center'>VR Software Design</p>
                </div>
              </div>
              <div className='flex flex-col border-[1.5px] border-[#EC1F26] rounded-[6px] w-[134px] h-[134px] pt-[10.79px] px-[10.79px]'>
                <div className='flex justify-end'><ImCross className='text-[#FF5359] w-[13px] cursor-pointer' /></div>
                <div className='flex flex-1 flex-col justify-center items-center gap-[10.73px]'>
                  ...
                  <p className='text-[clamp(10px,0.9114583333333334vw,14px)] font-[400] leading-[17.15px] text-center'>User Interface Design</p>
                </div>
              </div>
              <div className='flex flex-col border-[1.5px] border-[#EC1F26] rounded-[6px] w-[134px] h-[134px] pt-[10.79px] px-[10.79px]'>
                <div className='flex justify-end'><ImCross className='text-[#FF5359] w-[13px] cursor-pointer' /></div>
                <div className='flex flex-1 flex-col justify-center items-center gap-[10.73px]'>
                  ...
                  <p className='text-[clamp(10px,0.9114583333333334vw,14px)] font-[400] leading-[17.15px] text-center'>8 Bit Game Development</p>
                </div>
              </div>
            </div>
            <div className='h-[56px] bg-[#EC1F26] mt-[42px] rounded-b-[9px] flex justify-center items-center gap-[7px]'>
              <img src={addExpertise} alt="" className='w-[28.79px]' />
              <p className='text-[clamp(11px,0.9114583333333334vw,16px)] font-[400]'>Add Expertise</p>
            </div>
          </div>
        </div>
        ...
        <div className='flex flex-col gap-[28px] w-[30%] xsm:w-full sm:w-full'>
          <div className='flex flex-col dark:bg-[#2C2C2C] bg-white  rounded-t-[27.5px] rounded-b-[9px]'>
            <div className='flex items-center px-[23px] gap-[7.99px] h-[65px]'>
              ...
              <p className='text-[clamp(12px,1.3020833333333333vw,18px)] font-[700] text-center'>Team Members School Attend</p>
            </div>
            <div className='py-[1px] dark:bg-[#FFFFFF] bg-black mb-3 opacity-[0.15] gap-[18px]'></div>
