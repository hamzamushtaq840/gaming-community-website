    ...
    <div className='dark:text-white dark:bg-black pr-[10.98%] pl-[10.93%] min-h-[calc(100vh-72px)]'>
      <div className='flex justify-between pt-[71px] pb-[62px]'>
        <div className='flex gap-[14px]'>
          ...
          <button className='w-[9.844vw] h-[48px] rounded-[9px] bg-[rgba(255,255,255,0.25)] hover:bg-[#FF5359] text-white'>Following</button>
          <button className='w-[9.844vw] h-[48px] rounded-[9px] bg-[rgba(255,255,255,0.25)] hover:bg-[#FF5359] text-white'>Groups</button>
        </div>
        <Link to={"/knowledge-hub/add"}>
          <button className='w-[12.448vw] h-[48px] rounded-[9px] bg-primary text-white'>New Knowledge Hub Post</button>
        </Link>
      </div>
      <div>
        <h4 className='font-bold text-[26px] leading-[26px]'>All Knowledge Hub</h4>
        <div className='flex justify-between items-center max-h-[48px] mt-[32px]'>
          ...
          <div className='relative w-[25.417vw] rounded-[9px] h-[48px] flex border border-[rgba(255,255,255,0.25)]'>
            <input className='flex-1 h-full bg-transparent indent-[22px]' placeholder='Search Knowledge Hub'></input>
