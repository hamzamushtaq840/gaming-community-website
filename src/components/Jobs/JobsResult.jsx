...
export default function JobsResult() {
  return (
    <div>
      ...
      <div className='pt-[35px] flex flex-col gap-[18px]'>
        {[0, 1, 2, 3, 4, 5, 6].map((num) =>
          <Link to={'/jobs/information'}>
            <div className='grid grid-cols-1 gap-[15px] '>
              <div className='bg-[rgba(255,255,255,0.2)] rounded-[9px] min-h-[98px] pl-[22px] pr-[30px]'>
                <div className='flex justify-between items-center my-[18px]'>
                  <div className='flex items-center gap-[18px]'>
                    <img src={companyRecommendation}></img>
                    <div className='flex flex-col gap-[11px]'>
                      <h5 className='text-white font-[700] text-[16px] leading-[16px]'>Creative Editor</h5>
                      <div className='flex gap-[1.719vw] items-center'>
                        <p className='font-[700] text-[14px] leading-[14px] text-primary'>Paradox Institute</p>
                        ...
                        <div className='flex gap-[7px] items-center'>
                          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" color='black' xmlns="http://www.w3.org/2000/svg">
                            <path d="M8 0C6.41775 0 4.87103 0.469192 3.55544 1.34824C2.23985 2.22729 1.21447 3.47672 0.608967 4.93853C0.0034663 6.40034 -0.15496 8.00887 0.153721 9.56072C0.462403 11.1126 1.22433 12.538 2.34315 13.6569C3.46197 14.7757 4.88743 15.5376 6.43928 15.8463C7.99113 16.155 9.59966 15.9965 11.0615 15.391C12.5233 14.7855 13.7727 13.7602 14.6518 12.4446C15.5308 11.129 16 9.58225 16 8C15.9975 5.87904 15.1538 3.84566 13.6541 2.34591C12.1543 0.84616 10.121 0.00250216 8 0ZM8 14.5455C6.70543 14.5455 5.43994 14.1616 4.36354 13.4423C3.28715 12.7231 2.4482 11.7009 1.95279 10.5048C1.45738 9.30881 1.32776 7.99274 1.58032 6.72304C1.83288 5.45335 2.45627 4.28706 3.37167 3.37166C4.28707 2.45627 5.45335 1.83287 6.72305 1.58031C7.99274 1.32776 9.30881 1.45738 10.5048 1.95279C11.7009 2.4482 12.7231 3.28715 13.4423 4.36354C14.1616 5.43993 14.5455 6.70543 14.5455 8C14.5433 9.73531 13.8531 11.3989 12.626 12.626C11.3989 13.853 9.73531 14.5433 8 14.5455Z" fill="white" />
                            <path d="M8.72798 7.69997V3.63743C8.72798 3.44454 8.65136 3.25956 8.51497 3.12317C8.37858 2.98678 8.19359 2.91016 8.00071 2.91016C7.80783 2.91016 7.62284 2.98678 7.48645 3.12317C7.35006 3.25956 7.27344 3.44454 7.27344 3.63743V8.00106C7.27348 8.19393 7.35013 8.37889 7.48653 8.51525L9.66835 10.6971C9.80551 10.8295 9.98922 10.9028 10.1799 10.9012C10.3706 10.8995 10.553 10.823 10.6879 10.6882C10.8227 10.5534 10.8992 10.371 10.9008 10.1803C10.9025 9.98958 10.8292 9.80587 10.6967 9.6687L8.72798 7.69997Z" fill="white" />
                          </svg>
                          <p className='font-[400] text-[12px] leading-[12px] text-[rgba(255,255,255,0.5)]'>12 hours ago</p>
                        </div>
                      </div>
                    </div>
                  </div>
