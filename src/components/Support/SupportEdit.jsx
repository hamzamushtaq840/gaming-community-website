...
export default function SupportEdit() {
  return (
    <div className='dark:text-white dark:bg-black pr-[10.98%] pl-[10.93%] min-h-[calc(100vh-72px)] pb-[109px]'>
      <h3 className='font-bold text-[26px] leading-[26px] pt-[65px] mb-[32px]'>Help / Support</h3>
      <div className='bg-[rgba(255,255,255,0.15)] rounded-[9px] min-h-[891px] px-[47px] flex flex-col pt-[47px]'>
        ...
        <div className='flex flex-col gap-[15px]'>
          ...
          <div className='flex-1 flex flex-col gap-[15px]'>
            <label className='text-[rgba(255,255,255,0.5)] font-[700] text-[16px] leading-[16px]'>Phone Number</label>
          ...
          <div className='flex-1 flex flex-col gap-[15px]'>
            <label className='text-[rgba(255,255,255,0.5)] font-[700] text-[16px] leading-[16px]'>Email</label>
            <input className='w-full h-[48px] border border-[rgba(255,255,255,0.25)] rounded-[9px] flex overflow-hidden bg-transparent indent-[22px]' placeholder='Text'></input>
          </div>
