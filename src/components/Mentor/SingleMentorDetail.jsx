    ...
    <main className='py-[64px] min-h-[calc(100vh-72px)] flex xsm:flex-col sm:flex-col xsm:px-[6vw] lg:px-[6vw] sm:px-[6vw] gap-[2.0833333333333335vw] px-[8.28125vw] dark:bg-black dark:text-white bg-white text-black'>
      <aside className='w-[17.1875vw] min-w-[225px] h-[1%] xsm:w-full sm:w-full bg-white rounded-9px items-center dark:bg-[rgba(255,255,255,0.2)] rounded-[9px]'>
        ...
        <div className='flex flex-col items-center'>
          <div className='relative mt-[45px] mb-[30px] flex justify-center'>
            ...
            <div className='absolute bottom-0 text-custom-12 flex justify-center items-center leading-[13px] h-[23px] w-[119px] bg-primary rounded-full'>Mentor</div>
          </div>
      ...
      <section className='flex-1 flex flex-col gap-[25px] xsm:items-center sm:items-center'>
        <div className='flex gap-[14px]' >
          <NavLink to='/mentor/singleMentorAvalibility' className={({ isActive }) => isActive ? "bg-primary text-white rounded-[9px]" : "bg-white dark:bg-[rgba(255,255,255,0.2)]  rounded-[9px]"}>
            <button className='text-custom-16 px-[3.375em] py-[0.8125em]'>
              Avalibility
            </button>
          </NavLink>
          <NavLink to='/mentor/singleMentorAbout' className={({ isActive }) => isActive ? "bg-primary text-white rounded-[9px]" : "bg-white dark:bg-[rgba(255,255,255,0.2)]  rounded-[9px]"}>
            <button className='text-custom-16 px-[3.375em] py-[0.8125em]'>
              About
            </button>
          </NavLink>
...
export default SingleMentorDetail