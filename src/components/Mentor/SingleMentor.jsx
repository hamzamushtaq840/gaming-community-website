...
const SingleMentor = () => {
  ...
  return (
    <div className='w-full dark:hover:bg-[rgba(255,255,255,0.3)] hover:bg-[#ffffffd4] transition-all duration-300 cursor-pointer dark:bg-[rgba(255,255,255,0.2)] bg-white rounded-[9px] px-[1.40625vw] xsm:px-[20px] sm:px-[20px] flex' onClick={() => navigate('/mentor/singleMentorAvalibility')}>
      <img src={user} alt="" className='w-[90px] h-[90px] xsm:w-[50px] xsm:h-[60px] mr-[22px] my-[29px]' />
      <div className='flex flex-1 flex-col py-[29px] gap-[14px] justify-center'>
        <h1 className='text-custom-16 font-[700]'>Mentor Name</h1>
        <div className='flex gap-[17px] items-start'>
          <p className='text-custom-14'>Expertise:</p>
