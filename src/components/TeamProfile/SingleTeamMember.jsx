        ...
        <>
            <div className='flex gap-[10px] justify-between items-start'>
                ...
                <div className='flex gap-[0.5765625vw] pt-[8px]'>
                    <div className='flex justify-end'><MdEdit className='text-[#FF5359] w-[19px] cursor-pointer' onClick={() => setEditTeamMemberModal(true)} /></div>
                    <div className='flex justify-end'><ImCross className='text-[#FF5359] w-[13px] cursor-pointer' /></div>
                </div>
            </div>
            {editTeamMemberModal && <EditTeamMemberModal setModal={setEditTeamMemberModal} />}
        </>
    )
}
