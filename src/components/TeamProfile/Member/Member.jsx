...
import analyticsDownArrow from "../../../assets/analyticsDownArrow2.svg"
...
const Member = () => {
    return (
        <div className='dark:text-white dark:bg-black pr-[10.989583333333334vw] min-h-[calc(100vh-72px)] pl-[10.9375vw]'>
            <h3 className='font-[700] text-[26px] leading-[26px] py-[46px]'>Hi John Doe!</h3>
            <div className='pt-[36px] min-h-[412px] w-full bg-[rgba(255,255,255,0.15)] rounded-[9px] mb-[32px]  divide-y-2 divide-[rgba(255,255,255,0.15)]'>
                    ...
                    <table className='table-auto pt-0 mt-0 w-full h-full divide-y-2 divide-[rgba(255,255,255,0.15)]'>
                        <thead className='text-[#5760FE]'>
                            <tr className='p-0 h-[49px]'>
                                ...
                                <th className='text-left w-[107px] font-[700] text-[14px] leading-[14px] flex items-center h-full gap-[7px]'>TIME SPENT <img src={analyticsDownArrow} /></th>
                ...
                <p className='font-[700] text-[14px] leading-[14px] text-[#5760FE] pt-[22px] pb-[21px] text-center'>View All</p>
            </div>

            <div className='flex gap-[31px] pb-[55px]'>
